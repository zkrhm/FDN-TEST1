...
describe('test',()=>{
    it('test',async()=>{
        ...
        page.goto('https://www.facebook.com/v3.1/dialog/oauth?response_type=token&display=popup&client_id=366621340543848&redirect_uri=http://localhost:3000/static/redirect.html&scope=user_posts')
